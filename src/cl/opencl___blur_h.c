...
"enum ArgIdx{WIDTH,HEIGHT,DST_STRIVE,SRC_STRIVE,SIZE,__ARGS_CNT};void kernel "
"blurH(global char*_0_f,global const char*_0_11,global const int*_0_e){const "
"int _0_b=_0_e[WIDTH];const int _0_9=_0_e[HEIGHT];const int _0_6=_0_e[DST_STR"
"IVE];const int _0_7=_0_e[SRC_STRIVE];const int _0_d=_0_e[SIZE];const int _0_"
"c=_0_d/2;const int y=get_global_id(0);global const unsigned char*_0_a=_0_11+"
"y*_0_7;global const unsigned char*_0_10=_0_a;global unsigned char*_0_8=_0_f+"
"y*_0_6;unsigned int _0_12=(*_0_a)*(_0_c+1);for(int k=0;k<_0_c;++k){_0_12+=(*"
"_0_10);_0_10++;}for(int x=0;x<_0_b;++x){_0_12=_0_12+(*_0_10)-(*_0_a);if(x>_0"
"_c){_0_a++;}if(x<(_0_b-_0_c-1)){_0_10++;}*_0_8=_0_12/_0_d;++_0_8;}if(y<128){"
"for(global char*i=_0_f,*const e=_0_f+128;i !=e;++i){*i=0;}}}"
