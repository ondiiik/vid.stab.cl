...
kernels  = [
               ...
               [
                   "correlate.c",
                   [
                       [ "CORRELATE___WIDTH_PREVIOUS" ],
                       [ "CORRELATE___WIDTH_CURRENT"  ],
                       [ "CORRELATE___FIELD_SIZE"     ],
                       [ "CORRELATE___MAX_SHIFT"      ],
                       [ "__CORRELATE___ARGS_CNT"     ],
                       [ "CORRELATE___OFFSET_X"       ],
                       [ "CORRELATE___OFFSET_Y"       ],
                       [ "CORRELATE___FIELD_X"        ],
                       [ "CORRELATE___FIELD_Y"        ],
                       [ "CORRELATE___HEIGHT"         ],
                       [ "CORRELATE___BPP"            ],
